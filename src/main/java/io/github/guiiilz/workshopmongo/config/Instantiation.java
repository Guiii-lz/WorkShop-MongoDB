...
import io.github.guiiilz.workshopmongo.dto.AuthorDTO;
import io.github.guiiilz.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null,sdf.parse("21/03/2017"),"Partiu Viagem","Vou viajar para São Paulo. Abraços!", new AuthorDTO(maria));
